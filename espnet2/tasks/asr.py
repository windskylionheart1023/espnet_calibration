...
# Calibration
# calibration_base_choices = ClassChoices(
#     "calibration base loss",
#     classes=dict(
#         token_level_calibration=TokenLevelCalibration,
#     ),
#     type_check=AbsCalibration,
#     default=None,
#     optional=True,
# )
...
class ASRTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group = parser.add_argument_group(description="Calibration related")
        group.add_argument(
            "--partly_calibration",
            type=str2bool,
            default=False,
            help="If calibrate all classes",
        )
        group.add_argument(
            "--mmce",
            type=str2bool,
        ...
        group.add_argument(
            ...
            type=str2bool,
            default=False,
            help="change to FocalLS loss",
        )
        group.add_argument(
            "--base_attention_loss",
            type=str,
            default="LS",
            choices=["LS", "FocalLS", "ABdiv"],
            help="The type of base attention loss",
        )
        group.add_argument(
            "--ABdiv_conf",
            action=NestedDictAction,
            default={"alpha": 0.5, "beta": 0.5},
            help="The keyword arguments for AlphaBetaDiv loss",
        )
        group.add_argument(
            "--cali_lambda",
            type=int,
            default=100,
            help="calibration lambda",
        )
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModel:
        ...
        model = model_class(
            ...
            partly_calibration=args.partly_calibration,
            mmce=args.mmce,
            kde=args.kde,
            focal=args.focal,
            base_attention_loss=args.base_attention_loss,
            ABdiv_conf=args.ABdiv_conf,
            cali_lambda=args.cali_lambda,
            **args.model_conf,
        )
